...
experiences?  If not, why not?}.  The WLCG consists of four layers, or ``tiers''; 0, 1, 2
...
copy). Thirteen Tier 2\todo{That should be 1, right?} centers are responsible for a proportional
...
it would be an experiment?} and and new large scale projects in astro-particle
...
with the large data volumes?}. The resources to be
