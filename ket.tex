...
combines several middleware providers (ARC, gLite, UNICORE\todo{UNICORE is of no relevance for WLCG, basically no gLite component is used nowadays.} and
...
factor of 60 will be needed \todo{The factor 60 would be required, if
the Run2 computing model is extrapolated to Run4. New models forecast a
much smaller gap.\\MD: who'll fix this passage?}. However, assuming a flat budget, the
...
with the large data volumes?\\CW: Not al all! To save data volume one
needs smaller data tiers and smarter replica management.\\MD: Could you
explan that in the text?}. The resources to be
