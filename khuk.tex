...
so that in the end data of the order of magnitude of 100~PB \todo{CW: Are the 100PB yearly volumes or the amount of data to be on disk at any time?} will be stored to disk.
